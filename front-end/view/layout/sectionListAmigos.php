<div id="asideID" class="aside bg-white col-sm-5 col-md-4 col-lg-4">
    <div class="my-2">
        <h5 class="card-title Oswald">Últimas solicitudes</h5>
    </div>
    <div class="bg-light">
        <ul class="list-unstyled">
            ...
            <li class="media">
                ...
                <div class="media-body">
                    <h5 class="mt-0 mb-1 my-2 Open-Sans">Juan Peres</h5>
                    <div class="form-gruop my-2">
                        <button class="btn btn-primary Oswald" type="submit">
                            <i class="fas fa-user-plus"></i>
                            Confirmar
                        </button>
                        <button class="btn btn-danger Oswald" type="submit">
